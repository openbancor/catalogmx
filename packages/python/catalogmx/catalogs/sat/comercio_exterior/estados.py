...
class EstadoCatalog:
    ...
    _estados_usa: Optional[List[Dict]] = None
    _provincias_canada: Optional[List[Dict]] = None
    _estado_by_code: Optional[Dict[str, Dict]] = None
    ...
    @classmethod
    def get_estado(cls, code: str, country: Optional[str] = None) -> Optional[Dict]:
        """
    ...
    @classmethod
    def get_estado_usa(cls, code: str) -> Optional[Dict]:
        """Obtiene un estado de USA por su código"""
        return cls.get_estado(code, 'USA')

    @classmethod
    def get_provincia_canada(cls, code: str) -> Optional[Dict]:
        """Obtiene una provincia de Canadá por su código"""
        return cls.get_estado(code, 'CAN')

    @classmethod
    def is_valid(cls, code: str, country: Optional[str] = None) -> bool:
