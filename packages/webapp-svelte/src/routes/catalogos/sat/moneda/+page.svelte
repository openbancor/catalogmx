...
<svelte:head>
	...
	<meta name="description" content="Catalogo de monedas del SAT para CFDI 4.0." />
</svelte:head>
		...
		<div class="flex items-start gap-4">
			...
			<div>
				...
				<p class="text-slate-600 dark:text-slate-300">
					Codigos ISO 4217 de monedas validas para facturas electronicas (CFDI 4.0)
				</p>
			</div>
		</div>
	</div>
		...
		<div class="mt-8 card p-6">
			...
			<div class="space-y-2 text-sm text-slate-600 dark:text-slate-300">
				<p>
					...
					el comprobante, usando codigos ISO 4217.
				</p>
				<p>
				...
				<ul class="list-disc list-inside ml-4 space-y-1">
					...
					<li><strong>USD:</strong> Dolar Estadounidense</li>
					<li><strong>EUR:</strong> Euro</li>
					<li><strong>CAD:</strong> Dolar Canadiense</li>
					<li><strong>XXX:</strong> Sin moneda (operaciones que no involucran dinero)</li>
				</ul>
				<p>
					<strong>Fuente:</strong> Servicio de Administracion Tributaria (SAT) - ISO 4217
				</p>
				<p>
					<strong>Uso:</strong> Campo obligatorio en el CFDI 4.0 para especificar la moneda de la transaccion.
