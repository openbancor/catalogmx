...
export const datasetConfigs = [
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['id', 'nombre', 'descripcion', 'simbolo'],
    columns: [
      { key: 'id', label: 'Clave' },
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['code', 'description', 'name'],
    columns: [
      { key: 'code', label: 'Clave' },
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['codigo', 'nombre', 'iso2'],
    columns: [
      { key: 'codigo', label: 'Código' },
      { key: 'nombre', label: 'País' },
      { key: 'iso2', label: 'ISO-2' },
      { key: 'requiere_subdivision', label: 'Subdivisión' },
    ],
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['code', 'name', 'ciudad', 'estado', 'iata'],
    columns: [
      { key: 'code', label: 'Clave' },
      { key: 'name', label: 'Aeropuerto' },
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['code', 'name', 'state', 'coast'],
    columns: [
      { key: 'code', label: 'Clave' },
  ...
  },
  {
    ...
    category: 'fiscal',
    searchColumns: ['code', 'descripcion', 'clase_division', 'clase_riesgo'],
    columns: [
      { key: 'code', label: 'Clave' },
      { key: 'descripcion', label: 'Descripción' },
      { key: 'clase_division', label: 'Clase/Div.' },
      { key: 'clase_riesgo', label: 'Riesgo' },
      { key: 'grupo_embalaje', label: 'Grupo' },
    ],
  ...
  },
  {
    ...
    columns: [
      { key: 'code', label: 'Clave' },
      { key: 'descripcion', label: 'Tipo de Nómina' },
    ],
  ...
  },
  {
    ...
    columns: [
      { key: 'code', label: 'Clave' },
      { key: 'descripcion', label: 'Periodicidad' },
      { key: 'days', label: 'Días' },
    ],
  ...
  },
  {
    ...
    category: 'banking',
    searchColumns: ['fecha', 'tipo_cambio', 'fuente', 'moneda_origen', 'moneda_destino'],
    orderBy: 'fecha DESC',
    columns: [
      { key: 'fecha', label: 'Fecha' },
      { key: 'tipo_cambio', label: 'MXN/USD' },
